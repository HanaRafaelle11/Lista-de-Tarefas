...
export const BillingAdapter = {
  ...
  normalizeSubscription(sub) {
    ...
    const normalizedGateway = (sub.gateway || (sub.asaas_subscription_id ? 'asaas' : sub.mp_subscription_id ? 'mercadopago' : 'unknown')).toLowerCase();
    ...
    return {
      ...
      customerId: sub.asaas_customer_id || sub.mercadopago_customer_id || sub.mp_customer_id,
      subscriptionId: sub.asaas_subscription_id || sub.mp_subscription_id,
