...
// Todos os demais status bloqueiam.
// =========================================================
...
async function handleSubscriptionCreate(req, res) {
    ...
    try {
        ...
        const preapprovalPayload = {
            ...
            back_url: 'https://myflowday.com.br', // ✨ Adicionado obrigatoriamente para produção (corrige erro 400)
...
// =========================================================
// HANDLER: handleWebhookMercadoPago (ADAPTADO e BLINDADO)
...
async function handleWebhookMercadoPago(req, res) {
    try {
        ...
        // Definição segura da variável no escopo global da função
        ...
        return await BillingTracer.runWithTrace(requestTraceId, async () => {
            ...
            // Support both payment webhook models and action: "payment.updated"
